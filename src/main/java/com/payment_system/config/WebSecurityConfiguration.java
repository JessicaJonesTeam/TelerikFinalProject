...
import com.payment_system.JWT.JwtAuthenticationFilter;
import com.payment_system.JWT.JwtAuthorizationFilter;
...
//                config
                ...
                .antMatchers("/change-password/**").hasRole("CHANGEPASSWORD")
